...
must(service, "'SUPPLIER_PAYMENT'", "drawer movement has a supplier-specific type");
...
must(service, '${input.accountType},${walletId}::uuid', "invoice allocation keeps actual drawer/wallet metadata");
